        ...
        <div className="flex min-h-screen bg-gray-100">
            ...
            <aside className="w-64 bg-white shadow-md hidden md:block">
                <div className="p-6 border-b">
                    <h2 className="text-xl font-bold text-gray-800">JobSeeker</h2>
                </div>
                <nav className="p-4 space-y-2">
                    ...
                    <Link to={"/job/seeker/my-applications"}
                        className="block px-4 py-2 rounded hover:bg-gray-100 text-gray-700">
                        My Applications
                    </Link>
                    ...
                    <Link to={"/job/seeker/dashboard"}
                        className="block px-4 py-2 rounded-md bg-red-600 hover:bg-red-500 text-white font-semibold">
                        Sign Out
                    </Link>
                </nav>
            </aside>
